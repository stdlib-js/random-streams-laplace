...
```javascript
randomStream = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-laplace@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-streams-laplace/tags). For example,

```javascript
randomStream = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-laplace@v0.2.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var randomStream = require( 'path/to/vendor/umd/random-streams-laplace/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-laplace@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-streams-laplace.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-streams-laplace

[test-image]: https://github.com/stdlib-js/random-streams-laplace/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/random-streams-laplace/actions/workflows/test.yml?query=branch:v0.2.0
...
[cli-section]: https://github.com/stdlib-js/random-streams-laplace#cli
[cli-url]: https://github.com/stdlib-js/random-streams-laplace/tree/cli
[@stdlib/random-streams-laplace]: https://github.com/stdlib-js/random-streams-laplace/tree/main

[umd]: https://github.com/umdjs/umd
[es-module]: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Modules

[deno-url]: https://github.com/stdlib-js/random-streams-laplace/tree/deno
[deno-readme]: https://github.com/stdlib-js/random-streams-laplace/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-streams-laplace/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-streams-laplace/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-streams-laplace/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-streams-laplace/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/random-streams-laplace/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/random-streams-laplace/main/LICENSE
